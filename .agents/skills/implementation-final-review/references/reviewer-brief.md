...
An evidence ID is new for a canonical root only when its content digest is absent from that root's prior evidence. A new root proposal requires an evidence digest absent from every canonical root or globally unowned inventory. Credited receipt content digests and exact commands must be unique.
